        ...
        <div className="max-w-4xl mx-auto space-y-12">
          <section className="text-center">
            <h1 className="text-3xl md:text-4xl font-bold mb-4">
              Learn More About Solar Energy and EcoFlux
            </h1>
            <p className="text-lg md:text-xl text-muted-foreground">
              Discover how solar energy and EcoFlux can revolutionize your
          ...
          <section>
            ...
            <p className="mb-6">
              EcoFlux is not just another solar energy solution – it&apos;s a
            ...
            <div className="grid md:grid-cols-2 gap-6">
              ...
              <Card>
                ...
                <CardContent>
                  With EcoFlux, you get access to real-time data and insights
              ...
              <Card>
                ...
                <CardContent>
                  ...
                  time-of-use rates, EcoFlux helps you save more money
          ...
          <section className="text-center">
            ...
            <p className="mb-6">
              ...
              solar investment with EcoFlux. Start your journey to greater
              energy efficiency and savings today!
            </p>
            <Link href="/sign-in">
              <Button className="bg-green-600 text-white hover:bg-green-700">
                Get Started with EcoFlux
              </Button>
            </Link>
          </section>
        </div>
      ...
      <footer className="py-6 px-4 md:px-6 mt-8 bg-background border-t">
        <div className="max-w-4xl mx-auto text-center">
          <p className="text-sm text-muted-foreground">
            © 2025 EcoFlux. All rights reserved.
          </p>
